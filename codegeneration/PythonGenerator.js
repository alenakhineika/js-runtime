...
Visitor.prototype.visitPropertyExpressionAssignment = function(ctx) {
  /*
    console.log(ctx.getText()); // Текстовое значение узла
    console.log(ctx.getChildCount()); // Кол-во узлов потомков
    console.log(ctx.getChild(0).getText()); // console.log(ctx.propertyName().getText()) Параметр 'x'
    console.log(ctx.getChild(1).getText()); // ':'
    console.log(ctx.getChild(2).getText()); // console.log(ctx.singleExpression().getText()) Значение '1'
  */
